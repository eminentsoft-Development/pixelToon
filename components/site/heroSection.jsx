...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-[1200px] bg-[#F3F2F5] flex items-center justify-center p-12 md:p-24 font-sans overflow-hidden">
      ...
      >
        <div className="text-white text-center p-8">
          <h2 className="text-6xl font-black italic tracking-tighter leading-none">
            ZERO<span className="text-[#f07822] text-2xl align-top ml-1">2</span>
          </h2>
          <h2 className="text-6xl font-black italic tracking-tighter leading-none ml-10">HERO</h2>
        </div>
      </motion.div>
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-tr from-[#f07822]/30 to-transparent" />
      </motion.div>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute bottom-[5%] left-[1%] w-[420px] h-[300px] bg-white rounded-[45px] shadow-xl z-0 hidden xl:flex items-center justify-center border border-gray-200"
      >
        <span className="text-gray-200 font-black text-5xl italic uppercase">Adsin Hub</span>
      </motion.div>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute bottom-[2%] right-[1%] w-[400px] h-[320px] bg-[#f07822]/10 rounded-[45px] shadow-xl z-0 hidden xl:flex items-center justify-center border border-[#f07822]/20"
      >
        <Sparkles size={80} className="text-[#f07822]/20" />
      </motion.div>
        ...
        <aside className="col-span-12 lg:col-span-3 bg-gray-50/50 p-6 flex flex-col gap-5 border-r border-gray-100">
          <div className="bg-black text-white rounded-[35px] p-5 shadow-2xl">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-full bg-[#f07822] flex items-center justify-center font-black text-sm text-white">S</div>
          ...
          <div className="flex-1 bg-white rounded-[35px] p-7 border border-gray-100 shadow-sm">
            ...
            <ul className="space-y-4">
              {["About Us", "Vision", "Leadership", "Programs", "Courses", "Rankings", "Accreditation"].map((item) => (
                <li key={item} className="flex items-center gap-3 text-gray-600 hover:text-[#f07822] cursor-pointer text-[13px] font-bold group">
                  <span className="text-[8px] text-[#f07822] group-hover:translate-x-1 transition-transform">▶</span> {item}
                </li>
              ))}
            </ul>
          </div>
        ...
        <section className="col-span-12 lg:col-span-9 p-6 lg:p-7 flex flex-col">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-end mb-8 px-2">
              ...
              <span className="text-[11px] font-bold text-[#f07822] uppercase tracking-widest cursor-pointer border-b-2 border-[#f07822] pb-0.5 transition-all">View All</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="group h-40 rounded-[25px] bg-white border border-gray-100 flex flex-col justify-end p-5 overflow-hidden hover:border-[#f07822]/30 hover:shadow-xl transition-all cursor-pointer">
                   <div className="text-[9px] font-black text-gray-300 uppercase tracking-widest mb-auto">Adsin</div>
                   <h4 className="font-black text-sm uppercase leading-tight group-hover:text-[#f07822] transition-colors">{course.title}</h4>
                   <p className="text-[10px] text-gray-400 font-bold uppercase">{course.tag}</p>
                </div>
              ))}
            </div>
          </div>
