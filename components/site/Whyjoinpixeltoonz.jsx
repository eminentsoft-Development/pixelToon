...
import ScrollReveal from "./ScrollReveal"; // Ensure this path matches where you saved it
...
const features = [
  {
    icon: (
      ...
      >
        ...
        <path
          d="M20 44 L14 58 L32 52 L50 58 L44 44"
          stroke="currentColor"
          strokeWidth="3"
  ...
  },
  {
    icon: (
      ...
      >
        ...
        />
        <path
          d="M20 42 L20 52 M44 42 L44 52 M14 52 L50 52"
          stroke="currentColor"
          strokeWidth="3"
          strokeLinecap="round"
        />
  ...
  },
  {
    icon: (
      ...
      >
        ...
        />
        <path
          d="M10 52 Q10 38 32 38 Q54 38 54 52"
          stroke="currentColor"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
  ...
  },
  {
    icon: (
      ...
      >
        ...
        />
        <path
          d="M32 16 L32 8 M46 14 L40 20 M52 30 L44 30"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
        />
...
export default function WhyJoinPixeltoonz() {
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-b from-white via-orange-50/20 to-white overflow-hidden">
      {/* Background blob */}
      ...
      <div className="relative container mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          {features.map((feature, index) => (
            // We pass a staggered delay based on the index (0ms, 50ms, 100ms...)
            <ScrollReveal
              key={feature.title}
              delay={index * 50}
              direction="up"
              className="h-full"
            >
              <div className="group h-full relative bg-white rounded-2xl p-5 md:p-8 border border-orange-100 shadow-sm transition-all duration-300 hover:shadow-md">
                {/* Hover line effect */}
                ...
                <div className="relative mb-4 md:mb-5">
                  <div className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 rounded-xl bg-orange-50 text-orange-500 group-hover:bg-orange-500 group-hover:text-white transition-colors duration-300">
                    {feature.icon}
                  </div>
                </div>
