...
import { Users, Award, CheckCircle2, Sparkles, CheckCircle } from "lucide-react";
import Breadcrumbs from "@/components/site/Breadcrumbs";
import Image from "next/image";
import ScrollReveal from "./ScrollReveal"; // Use your existing lightweight animation wrapper

const stats = [
  { icon: <Users size={24} />, label: "Max Batch Size", value: "12 Students" },
  { icon: <Award size={24} />, label: "Certification", value: "ISO 9001:2008" },
  { icon: <CheckCircle2 size={24} />, label: "Affiliation", value: "STED Council" },
  { icon: <Sparkles size={24} />, label: "Method", value: "Production Oriented" },
];
      ...
      <section className="py-16 md:py-24 container overflow-hidden bg-white">
        <div className="mx-auto">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            {/* LEFT IMAGE COLUMN */}
            <ScrollReveal delay={0} direction="left" className="relative">
              ...
              <div className="min-h-[450px] lg:min-h-[830px] rounded-3xl lg:rounded-[3rem] overflow-hidden shadow-2xl relative">
                <Image
                  ...
                  priority // ✅ Critical for performance: Loads this above-the-fold image immediately
                />
            ...
            {/* RIGHT TEXT COLUMN */}
            <ScrollReveal delay={100} direction="right" className="flex flex-col gap-4">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            {stats.map((stat, i) => (
              <ScrollReveal
                key={i}
                delay={i * 100} // Staggered delay for each item
                direction="up"
                className="group flex flex-col items-center text-center lg:items-start lg:text-left h-full"
              >
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.06)] rounded-[3rem] overflow-hidden border border-neutral-100">
            ...
            <ScrollReveal delay={0} direction="up" className="h-full">
              <div className="bg-neutral-950 p-10 md:p-16 flex flex-col justify-center relative overflow-hidden group h-full">
            ...
            <ScrollReveal delay={150} direction="up" className="h-full">
              <div className="bg-slate-50 p-10 md:p-16 flex flex-col justify-center group h-full">
