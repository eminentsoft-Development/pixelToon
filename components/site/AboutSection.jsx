      ...
      <div className="px-4 lg:px-28 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            <ScrollReveal delay={100} direction="up" className="space-y-5 md:space-y-6">
            ...
            <ScrollReveal delay={200} direction="up" className="mt-6">
              <Link
                href="/about-us"
                prefetch={false}
          ...
          <div className="lg:col-span-5 relative mt-12 lg:mt-0">
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              ...
              {/* Left Column of Images -> Animates UP */}
              ...
              {/* Right Column of Images -> Animates DOWN */}
        ...
        {/* Info Cards -> Animates UP */}
        <ScrollReveal delay={300} direction="up">
          <div className="relative mt-12 md:mt-16 overflow-hidden rounded-[2rem] md:rounded-[3rem] bg-[#0a0a0a] p-6 md:p-16 text-white shadow-2xl">
