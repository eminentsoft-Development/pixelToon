...
// ✅ Moved outside — created once at module load, never recreated
...
// ✅ Shared viewport config — one object, reused everywhere
const viewportOnce = { once: true, margin: "-100px" };
const viewportLoose = { once: true, margin: "-50px" };
    ...
    <section className="relative w-full py-16 md:py-24 bg-white overflow-hidden">
      <div className="px-4 lg:px-28 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <h2 className="text-3xl md:text-6xl font-black text-gray-900 leading-[1.1] tracking-tighter">
                ABOUT PIXELTOONZ <br />
                <span className="text-gray-400">ACADEMY OF FILM & MEDIA DESIGN</span>
              </h2>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-5 md:space-y-6">
              ...
              <p className="text-sm md:text-base text-gray-500 leading-relaxed">
                Providing the best multimedia courses in Animation, VFX, 3D Design, Film Editing,
                Photography, Cinematography, Graphics Design and Web Technologies. As the best film
                editing institute in Kerala, we personally understand the student&apos;s natural ability
                and accordingly inculcate &quot;Creativity&quot; with the right blend of motivation & inspiration.
              </p>
            </motion.div>

            {/* ✅ Link wraps a plain anchor-styled button — no nested interactive elements */}
            <motion.div variants={itemVariants} className="mt-6">
              <Link
                href="/about-us"
                prefetch={false}
                className="group inline-flex items-center gap-3 bg-black text-white px-8 py-4 rounded-full font-bold transition-all hover:bg-yellow-400 hover:text-black shadow-lg hover:scale-[1.02] active:scale-[0.98]"
              >
                DISCOVER MORE
          ...
          {/* RIGHT: Visual Collage — single parent observer, children animate together */}
          <motion.div
          ...
          >
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {/* ✅ Child uses variant inherited from parent — no separate scroll observer */}
              <motion.div variants={colLeftVariants} className="space-y-3 md:space-y-4 will-change-transform">
              ...
              <motion.div variants={colRightVariants} className="space-y-3 md:space-y-4 pt-8 md:pt-12 will-change-transform">
                <div className="relative h-56 md:h-80 rounded-2xl md:rounded-3xl overflow-hidden shadow-md border-2 md:border-4 border-yellow-400 bg-gray-100">
                  <Image
                    ...
                    fill
                    sizes="(max-width: 768px) 45vw, 25vw"
                    // ✅ Removed priority — this is below the hero fold, not LCP
                    className="object-cover"
                  />
                </div>
                <div className="relative h-48 md:h-64 rounded-2xl md:rounded-3xl overflow-hidden shadow-md bg-gray-100">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          viewport={viewportLoose}  // ✅ once:true prevents re-animation on scroll back
        ...
        >
          ...
          <div className="grid grid-cols-1 divide-y divide-white/10 md:grid-cols-3 md:divide-x md:divide-y-0">
            <div className="group relative flex flex-col py-6 md:px-10 md:py-0 first:pl-0 last:pr-0">
              <span className="mb-4 font-mono text-[10px] md:text-sm tracking-widest text-yellow-400">01 // MISSION</span>
            ...
            <div className="group relative flex flex-col py-6 md:px-10 md:py-0">
              <span className="mb-4 font-mono text-[10px] md:text-sm tracking-widest text-yellow-400">02 // VISION</span>
              <h4 className="mb-3 text-2xl md:text-3xl font-black uppercase tracking-tighter">
            ...
            <div className="group relative flex flex-col py-6 md:px-10 md:py-0">
              <span className="mb-4 font-mono text-[10px] md:text-sm tracking-widest text-yellow-400">03 // MOTTO</span>
              <h4 className="mb-3 text-2xl md:text-3xl font-black uppercase tracking-tighter">
                Our <span className="text-yellow-400">MOTTO</span>
              </h4>
              <p className="text-base md:text-lg italic font-medium leading-snug text-white">
                &quot;Every individual is creatively endowed. They just need the right teacher to{" "}
